...
export default function MyInquiry() {
  return (
    <MyPageLayout title="1:1 문의하기" eyebrow="INQUIRY" description="예약 변경, 취소, 상품 상담을 우노트래블에 남길 수 있습니다." activePath="/mypage/inquiry">
      <div className="grid two">
        <article className="card"><div className="card-kicker">NOTICE</div><h3>예약시 주의사항</h3><p>예약 전 확인해야 하는 안내사항으로 연결됩니다.</p></article>
        <article className="card"><div className="card-kicker">CANCEL</div><h3>취소 환불 안내</h3><p>취소 및 환불 기준 안내로 연결됩니다.</p></article>
      </div>
      <div className="form-grid">
        <label className="field full"><span>문의 내용</span><textarea placeholder="이곳에 궁금한 사항을 입력해 주세요. 한글 기준 20자 이상 입력을 권장합니다." /></label>
      </div>
      <div className="actions"><button className="primary-action" type="button">문의 보내기</button><button className="ghost-action" type="button">파일첨부</button></div>
      <div className="notice-box"><p>실제 백엔드 연동 시 g5_write_cusTour 및 댓글 구조와 연결합니다.</p></div>
    </MyPageLayout>
  );
}
