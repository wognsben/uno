...
export default function MyTour() {
  return (
    <MyPageLayout title="투어 신청 / 예약 전환" eyebrow="TOUR REQUEST" description="장바구니에 담긴 투어를 실제 예약 신청으로 전환하는 단계입니다." activePath="/mypage/tour">
      <div className="grid two">
        <article className="card"><div className="card-kicker">STEP 01</div><h3>장바구니 확인</h3><p>상품, 투어일, 예약금, 현지지불금을 확인합니다.</p></article>
        <article className="card"><div className="card-kicker">STEP 02</div><h3>투어 신청</h3><p>기존 chk_regist() 흐름과 연결해 예약 신청으로 전환합니다.</p></article>
      </div>
      <div className="actions"><button className="primary-action" type="button">투어 신청</button><button className="ghost-action" type="button" onClick={() => navigateTo("/mypage/cart")}>장바구니로 돌아가기</button></div>
    </MyPageLayout>
  );
}
