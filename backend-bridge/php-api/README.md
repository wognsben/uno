...
React 프런트에서는 최종적으로 `/api/auth/session`, `/api/products/:id`, `/api/cart`, `/api/reservations/draft`, `/api/reservations/:rid`, `/api/reservations/:rid/confirm`, `/api/my/reservations` 또는 서버 rewrite 설정에 맞춘 경로로 호출합니다.
